...
alias pwn_template='wget https://raw.githubusercontent.com/w3th4nds/Helping-Hand/refs/heads/main/dotfiles/solver.py && echo "[+] solver.py created!"'
...
alias rename='~/github/exploit-template/rename.sh'
